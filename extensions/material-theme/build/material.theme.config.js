...
function activate(context) {
	return __awaiter(this, void 0, void 0, function* () {
		context.globalState.setKeysForSync([
			extension_manager_1.extensionManager.VERSION_KEY,
		]);
		...
		if (
			(installationType.firstInstall || installationType.update) &&
			(yield changelog_manager_1.changelogManager.askShowChangelog())
		) {
		...
		vscode_1.commands.registerCommand(
			...
			ThemeCommands.setAccent
		);
		vscode_1.commands.registerCommand('materialTheme.showReleaseNotes', () =>
			__awaiter(this, void 0, void 0, function* () {
				return releaseNotesView.show();
			})
		);
	});
}
